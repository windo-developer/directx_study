...
#pragma region Camera
	...
	camera->AddComponent(make_shared<Camera>()); // near = 1, far = 1000, fov = 45 (defulat setting)
...
//#pragma region Green Dircetional Light
//	{
...
//		light->GetLight()->SetDiffuse(Vec3(1.f, 0.f, 0.1f));
